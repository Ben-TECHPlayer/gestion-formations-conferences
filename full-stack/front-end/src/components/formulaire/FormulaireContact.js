    ...
    return (
        ...
        <form id="formulaire-contact" onSubmit={onSubmit}>
            ...
            <select name="requestType" required>
                ...
                <option value="Profil">Questions sur votre profil</option>
                <option value="Ateliers">Questions sur les ateliers en ligne</option>
                <option value="Entreprise">Questions sur l'entreprise</option>
            </select>
