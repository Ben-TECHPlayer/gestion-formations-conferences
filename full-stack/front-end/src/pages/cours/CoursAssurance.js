        ...
        <main className="cours-page">
            <div className="cours-container">
                <div className="cours-header">
                    ...
                    <p className="sous-titre">Découvrez les bases du commerce, de la gestion et de la prise de parole pour booster votre confiance dans une assurance.</p>
                </div>
