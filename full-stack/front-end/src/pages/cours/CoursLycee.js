        ...
        <main className="cours-page">
            <div className="cours-container">
                <div className="cours-header">
                    <h1>Cours & Ateliers pour les lycéens</h1>
                    <p className="sous-titre">Découvrez les bases du commerce, de la gestion et de la prise de parole pour booster votre confiance dès le lycée.</p>
                </div>
